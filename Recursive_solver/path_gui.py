...
class GUI:
    ...
    def load_images(self):
        IMAGES['grass'] = pg.transform.scale(pg.image.load('/Users/elkenken/CIS163-F24/Projects/Recursive_solver/images/grass.png'), (IMAGE_SIZE, IMAGE_SIZE))
        IMAGES['ocean'] = pg.transform.scale(pg.image.load('/Users/elkenken/CIS163-F24/Projects/Recursive_solver/images/ocean.png'), (IMAGE_SIZE, IMAGE_SIZE))
        IMAGES['start'] = pg.transform.scale(pg.image.load('/Users/elkenken/CIS163-F24/Projects/Recursive_solver/images/start.png'), (IMAGE_SIZE, IMAGE_SIZE))
        IMAGES['end'] = pg.transform.scale(pg.image.load('/Users/elkenken/CIS163-F24/Projects/Recursive_solver/images/end.png'), (IMAGE_SIZE, IMAGE_SIZE))
        IMAGES['human'] = pg.transform.scale(pg.image.load('/Users/elkenken/CIS163-F24/Projects/Recursive_solver/images/human.jpg'), (IMAGE_SIZE, IMAGE_SIZE))
    ...
    def run_game_on_board(self):
        ...
        while running:
            ...
            font = pg.font.SysFont("Arial", 36)
            txtsurf = font.render("You did it!", True, 'white')
            self._screen.blit(txtsurf, (self._screen.get_width() // 2 - txtsurf.get_width() // 2,
                                        self._screen.get_height() - 2 * txtsurf.get_height()))
            pg.display.flip()
